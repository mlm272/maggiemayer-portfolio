        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            <div className="space-y-5">
              ...
              <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                Currently at <span className="font-semibold text-primary-600">Troutwood</span>, I run the website and coded it fully by myself using CSS, HTML, and JavaScript. I handle all aspects of front-end development and UX strategy, creating responsive layouts and visual storytelling that enhance user engagement. I also design for our social media and newsletters, and have experience creating videos and animations using Adobe Animate, Adobe After Effects, Lottie, and GSAP.
              </p>
              <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
